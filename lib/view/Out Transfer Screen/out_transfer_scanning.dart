...
class OutTransferScan extends StatefulWidget {
  const OutTransferScan({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _OutTransferScanState();
}

class _OutTransferScanState extends State<OutTransferScan> {
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) async {
      ...
      try {
        await outTransferController.scanItem(
          result!.code!,
        );

        CommonWidgets.commonDialog(
            context, outTransferController.itemName.value, AddUpdateItem(),
            actions: [
              Row(
                children: [
                  Expanded(
        ...
        log("${outTransferController.selectedItem.value.description ?? ""} scandata");
